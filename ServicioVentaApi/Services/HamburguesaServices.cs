...
namespace ServicioVentaApi.Services
{
    public class HamburguesaServices
    {
        ...
        public async Task<Hamburguesa> CreateOne(CreateHamburguesaDto dto)
        {
            // Convertimos la lista de ingredientes a string
            var ingredientesStr = string.Join(", ", dto.Ingredientes);
            ...
            await _db.Hamburguesas.AddAsync(hamburguesa);
